<template>
  <div class="modal fade container-fluid" id="playerDetailsShared2" tabindex="-1" aria-labelledby="exampleModalLabel"
       aria-hidden="true">
...
module.exports = {
  ...
  methods: {
    show(id) {
      ...
      const myModal = new bootstrap.Modal(document.getElementById('playerDetailsShared2'), {})
      myModal.show();
      this.initConnection();
    },
    ...
    async initConnection() {
      ...
      this.oriShare = await new this.web3.eth.Contract(shareAbi.abi, "0xf2d25a74Be5665458454aE6A3EdCEef9496d0876");
    ...
    async submitBuy() {
      ...
      let allowance = await this.oriToken.methods
          .allowance(this.accounts[0], "0xf2d25a74Be5665458454aE6A3EdCEef9496d0876")
          .call();
      allowance = parseInt(allowance);

      if (allowance < paymentAmount) {
        const approve = await this.oriToken.methods
            .approve("0xf2d25a74Be5665458454aE6A3EdCEef9496d0876", 7500000 * 100000)
